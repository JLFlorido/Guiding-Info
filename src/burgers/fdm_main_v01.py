"""
fdm_main_v01.py
This python script uses scipy#s odeint to solve Burger's PDE via taking finite differences, for v = 0.01
Usage:
    fdm_main_v01.py [--N=<N>] [--nt=<nt>]
    fdm_main_v01.py -h | --help
Options:
