...
Use fdm to obtain a ground truth solution to compare against with PINNs. The two provided use a viscosity of 0.01, or 0.001, but this can be easily changed. Note the value used in the above is v=0.01/pi
